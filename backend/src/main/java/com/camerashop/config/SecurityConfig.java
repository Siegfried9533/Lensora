    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/health", "/api/auth/**", "/api/categories/**", "/api/products/**", "/api/assets/**", "/api/payment/momo/ipn", "/api/payment/momo/callback", "/api/shipping/**", "/api/notifications/system", "/api/chatbot/**").permitAll()
