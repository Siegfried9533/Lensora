    ...
    public void run(String... args) {
        ...
        List<Notification> seedNotifications = Arrays.asList(
                Notification.builder()
                        ...
                        .message("Thank you for joining Lensora! Browse our collection of premium cameras, lenses, and equipment. Feel free to explore and find the perfect gear for your needs.")
                ...
                Notification.builder()
                        ...
                        .user(adminUser)
                        .title("Welcome to Lensora!")
                        .message("Thank you for joining Lensora! As an admin, you can manage products, orders, and users from your dashboard.")
                        .type(NotificationType.SYSTEM)
                        .isRead(false)
                        .isActionRequired(false)
                        .build()
