-- ============================================================================
-- seed_test_data.sql
-- Dữ liệu thử nghiệm thiết bị máy ảnh thực tế cho cơ sở dữ liệu camera_shop
-- An toàn khi chạy nhiều lần (lũy đẳng)
--
-- Cách sử dụng:
...
-- ============================================================================
-- 1. XÓA DỮ LIỆU THỬ NGHIỆM HIỆN CÓ (giữ lại người dùng)
-- ============================================================================
...
-- ============================================================================
-- 3. CHÈN SẢN PHẨM (12 sản phẩm với tên tiếng Việt thực tế, giá VND)
-- ============================================================================

-- user_id tham chiếu đến testuser được tạo bởi DataInitializer.
-- Vì ID người dùng là UUID được tạo khi chạy, chúng tôi tra cứu động.
...
-- Dự phòng: nếu chưa có người dùng nào tồn tại, chúng tôi không thể tiếp tục chèn sản phẩm
-- yêu cầu một user_id hợp lệ. DataInitializer đáng lẽ đã tạo họ.
-- Nếu chạy script này độc lập trước DataInitializer, hãy chèn một người dùng tối thiểu:
...
INSERT INTO products (product_id, category_id, user_id, product_name, brand, description, price, stock_quantity, created_at) VALUES
    -- c1: Máy ảnh cao cấp (Máy ảnh cao cấp)
...
INSERT INTO assets (asset_id, category_id, user_id, model_name, brand, daily_rate, status, serial_number, created_at) VALUES
    -- a1: Flycam (Máy bay không người lái)
    ...
    -- a5: Ống kính cho thuê (Thuê ống kính)
...
-- ============================================================================
-- 5. CHÈN HÌNH ẢNH SẢN PHẨM (với URL Unsplash thực)
-- ============================================================================

INSERT INTO product_images (image_id, product_id, url, is_primary) VALUES
    -- Leica M11 (p-01) - 2 hình ảnh
    ...
    -- Hasselblad X2D (p-03) - 2 hình ảnh
    ...
    -- Fujifilm GFX 100S (p-04) - 2 hình ảnh
    ...
    -- Fujifilm X-H2S (p-08) - 2 hình ảnh
    ...
    -- Sony RX100 VII (p-09) - 2 hình ảnh
    ...
    -- Sony FE 24-70mm GM II (p-10) - 2 hình ảnh
    ...
    -- Canon RF 70-200mm (p-11) - 2 hình ảnh
    ...
    -- Peak Design Balo (p-12) - 2 hình ảnh
    ...
    -- ProGrade CFexpress (p-13) - 1 hình ảnh
...
-- ============================================================================
-- 6. CHÈN HÌNH ẢNH TÀI SẢN (với URL Unsplash thực)
-- ============================================================================

INSERT INTO asset_images (image_id, asset_id, url, is_primary) VALUES
    -- DJI Mavic 3 Pro (a-01) - Flycam
    ...
    -- DJI RS 3 Pro Gimbal (a-03) - Bộ ổn định
    ...
    -- Zhiyun Crane 3S (a-04) - Bộ ổn định
    ...
    -- Sennheiser MKH 416 (a-05) - Âm thanh
    ...
    -- Rode Wireless GO II (a-06) - Âm thanh
    ...
    -- Aputure LS 600d Pro (a-07) - Chiếu sáng
    ...
    -- Profoto B10X Plus (a-08) - Chiếu sáng
    ...
    -- Canon EOS R5 (a-09) - Thuê body máy ảnh
    ...
    -- Sony FE 24-70mm GM II (a-10) - Thuê ống kính
    ...
    -- Canon RF 70-200mm (a-11) - Thuê ống kính
    ...
    -- Manfrotto 055 Sợi carbon (a-12) - Chân máy
    ...
    -- Peak Design Travel Tripod (a-13) - Chân máy
